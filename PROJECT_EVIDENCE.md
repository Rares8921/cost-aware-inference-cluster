...
- Created a deterministic autoscaling simulation report covering queue pressure, latency-threshold pressure, cooldowns, warm-pool floors, max-worker limits, and projected cost-budget blocks.
